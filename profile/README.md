...
| 이름 | 학과/학년 | 역할 | 기술 스택 |
|------|----------|------|----------|
| **이대연** | 소프트웨어공학과 4학년 | 👑 팀장 | React, Spring Boot, FastAPI, AWS, Firebase, Figma, ML/DL |
| **김지나** | 산업디자인학과 3학년 | 🎨 UI/UX 디자이너 | Figma, Blender, 3ds Max, Adobe Suite, Android Studio |
| **유현곤** | 컴퓨터공학과 3학년 | ⚙️ 백엔드 개발 | Java, Python, Eclipse, Android Studio, StarUML |
| **이다하** | 소프트웨어공학과 3학년 | ⚙️ 백엔드 개발 | Node.js, Java, 프론트엔드 기초 |
| **김나영** | 컴퓨터공학과 3학년 | 💻 풀스택 개발 | Android Studio, VS Code, MySQL, HTML/CSS |
...
| 기간 | 내용 |
|------|------|
| 2025.09 ~ 2025.11 | 프로젝트 기획 및 1차 발표 |
| 2025.12 ~ 2026.02 | 핵심 기능 개발 및 2차 발표 |
| 2026.03 ~ 2026.04 | 고도화 및 3차 발표 |
| 2026.05 ~ 2026.06 | 최종 완성 및 4차 발표 |
